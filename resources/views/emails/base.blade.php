...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 700px;" class="content">
    ...
    <tr>
        <td align="right" bgcolor="#ffffff" style="padding: 5px 5px 5px 5px; color: #ffffff; font-family: Arial, sans-serif; font-size: 36px; font-weight: bold;">
            <img src="{{ asset('images/logo-cliente2.jpg') }}" alt="" width="30%"  style="margin-top: 7px;">
        </td>
    </tr>
